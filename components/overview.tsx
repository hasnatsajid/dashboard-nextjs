...
import ProfilePic1 from '../public/assets/img/team/profile-picture-1.jpg';
import ProfilePic2 from '../public/assets/img/team/profile-picture-2.jpg';
import ProfilePic3 from '../public/assets/img/team/profile-picture-3.jpg';
import ProfilePic4 from '../public/assets/img/team/profile-picture-4.jpg';
import ProfilePic5 from '../public/assets/img/team/profile-picture-5.jpg';
                  ...
                  <div className="list-group list-group-flush">
                    ...
                    <a href="#" className="list-group-item list-group-item-action border-bottom">
                      <div className="row align-items-center">
                        <div className="col-auto">
                          {/* <!-- Avatar --> */}
                          <Image width={32} height={32} alt="Image  placeholder" src={ProfilePic1} className="avatar-md rounded" />
                        </div>
                    ...
                    <a href="#" className="list-group-item list-group-item-action border-bottom">
                      <div className="row align-items-center">
                        <div className="col-auto">
                          {/* <!-- Avatar --> */}
                          <Image width={32} height={32} alt="Image  placeholder" src={ProfilePic2} className="avatar-md rounded" />
                        </div>
                        <div className="col ps-0 ms-2">
                          <div className="d-flex justify-content-between align-items-center">
                            <div>
                    ...
                    <a href="#" className="list-group-item list-group-item-action border-bottom">
                      <div className="row align-items-center">
                        <div className="col-auto">
                          {/* <!-- Avatar --> */}
                          <Image width={32} height={32} alt="Image  placeholder" src={ProfilePic3} className="avatar-md rounded" />
                        </div>
                    ...
                    <a href="#" className="list-group-item list-group-item-action border-bottom">
                      <div className="row align-items-center">
                        <div className="col-auto">
                          {/* <!-- Avatar --> */}
                          <Image width={32} height={32} alt="Image  placeholder" src={ProfilePic4} className="avatar-md rounded" />
                        </div>
                        <div className="col ps-0 ms-2">
                          <div className="d-flex justify-content-between align-items-center">
                            <div>
                    ...
                    <a href="#" className="list-group-item list-group-item-action border-bottom">
                      <div className="row align-items-center">
                        <div className="col-auto">
                          {/* <!-- Avatar --> */}
                          <Image width={32} height={32} alt="Image  placeholder" src={ProfilePic5} className="avatar-md rounded" />
                        </div>
                        <div className="col ps-0 ms-2">
                          <div className="d-flex justify-content-between align-items-center">
                            <div>
              ...
              <li className="nav-item dropdown ms-lg-3">
                <a className="nav-link dropdown-toggle pt-1 px-0" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  <div className="media d-flex align-items-center">
                    <Image width={32} height={32} className="avatar rounded-circle" alt="Image  placeholder" src={ProfilePic3} />
                      ...
                      <div className="row align-items-center">
                        <div className="col-auto">
                          ...
                          <a href="#" className="avatar">
                            <Image width={32} height={32} className="rounded" alt="Image  placeholder" src={ProfilePic1} />
                          </a>
                        </div>
                    ...
                    <li className="list-group-item px-0">
                      <div className="row align-items-center">
                        <div className="col-auto">
                          {/* <!-- Avatar --> */}
                          <a href="#" className="avatar">
                            <Image width={32} height={32} className="rounded" alt="Image  placeholder" src={ProfilePic2} />
                          </a>
                        </div>
                        <div className="col-auto ms--2">
                          <h4 className="h6 mb-0">
                    ...
                    <li className="list-group-item px-0">
                      <div className="row align-items-center">
                        <div className="col-auto">
                          {/* <!-- Avatar --> */}
                          <a href="#" className="avatar">
                            <Image width={32} height={32} className="rounded" alt="Image  placeholder" src={ProfilePic3} />
                          </a>
                        </div>
                        <div className="col-auto ms--2">
                          <h4 className="h6 mb-0">
                    ...
                    <li className="list-group-item px-0">
                      <div className="row align-items-center">
                        <div className="col-auto">
                          {/* <!-- Avatar --> */}
                          <a href="#" className="avatar">
                            <Image width={32} height={32} className="rounded" alt="Image  placeholder" src={ProfilePic4} />
                          </a>
                        </div>
                        <div className="col-auto ms--2">
                          <h4 className="h6 mb-0">
        ...
        <div className="card-body bg-gray-800 text-white pt-4">
          ...
          <div className="d-flex justify-content-center">
            <a className="me-3" href="https://themesberg.com/product/admin-dashboard/volt-bootstrap-5-dashboard" target="_blank" rel="noreferrer">
              <Image width={32} height={32} src="/assets/img/technologies/bootstrap-5-logo.svg" className="image image-xs" />
            </a>
            <a href="https://demo.themesberg.com/volt-react-dashboard/#/" target="_blank" rel="noreferrer">
              <Image width={32} height={32} src="/assets/img/technologies/react-logo.svg" className="image image-xs" />
            </a>
          </div>
        </div>
      </div>
